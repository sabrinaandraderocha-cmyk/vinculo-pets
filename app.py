...
# Para deploy: use instance/ para organizar o banco (Render)
...
# ✅ Importante: Render/Gunicorn não executa o bloco __main__.
# Então garantimos que as tabelas existam ao importar o app.
init_db()
...
if __name__ == "__main__":
    # init_db() já rodou no import; manter aqui não faz mal
